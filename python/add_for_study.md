<i>Этот файл предназначен для пополнения той информацией, которая дается в уроках или упоминается в изучаемой теме, но к ней не относится напрямую и потому в ней не раскрывается. <br>
